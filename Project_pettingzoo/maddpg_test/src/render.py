...
if __name__ == "__main__":
    ...
    env = pistonball.parallel_env(render_mode="rgb_array")
    ...
    path = "./models/MADDPG/MADDPG_trained_agent4.pt"
    maddpg.loadCheckpoint(path)


    # Define test loop parameters
    episodes = 20  # Number of episodes to test agent on
    ...
    imageio.mimwrite(
        os.path.join("./videos/", "pistonball4.gif"), frames, duration=10
    )