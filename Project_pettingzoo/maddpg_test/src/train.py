...
if __name__ == "__main__":
    ...
    NET_CONFIG = {
        ...
        "c_size": [2, 64],  # CNN channel size
        "k_size": [2, 2],  # CNN kernel size for Conv2d
        "s_size": [2, 2],  # CNN stride size for Conv2d
    ...
    path = "./models/MADDPG"
    filename = "MADDPG_trained_agent4.pt"
