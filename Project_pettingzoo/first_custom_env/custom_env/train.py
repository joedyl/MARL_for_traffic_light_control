"""This tutorial shows how to train an MADDPG agent
...
if __name__ == "__main__":
    ...
    INIT_HP["N_AGENTS"] = len(env.possible_agents)
    ...
    max_episodes = 3000  # Total episodes (default: 6000)
    max_steps = 10  # Maximum steps to take in each episode
    ...
    wandb.init(
    project="uwe-ai",  ##replace this with own project
    entity='joe-lyall22', ## replace this with own user
    config= {"episodes": max_episodes, 
            "steps": max_steps,
            "Learning Rate": INIT_HP["LR"],
            "Discount rate": INIT_HP["GAMMA"],
            "tau(parameter update)": INIT_HP["TAU"]})
    ...
    for idx_epi in trange(max_episodes):
        ...
        if (idx_epi + 1) % evo_epochs == 0:
            ...
            wandb.log({"fitness": best_fitness})
